...
export default function App() {
  ...
  // Initially empty so no dummy clips show up until generated by user
  ...
  // FULLY OPTIMIZED 15MBPS HD & BUTTERY SMOOTH EXPORT LOGIC
  const handleDownloadClip = async (clip: GeneratedClip) => {
    ...
    setToast(`⏳ ${ratio} रेश्यो और 15Mbps एचडी क्वालिटी के साथ क्लिप प्रोसेस हो रही है...`);
    ...
    try {
      ...
      // 30 FPS for buttery smooth playback without any frame dropping or lag
      ...
      try {
        // High 15 Mbps Bitrate for crystal clear HD quality and zero pixelation
        recorder = new MediaRecorder(finalStream, { mimeType: 'video/webm; codecs=vp9,opus', videoBitsPerSecond: 15000000 });
      } catch {
        try {
          recorder = new MediaRecorder(finalStream, { mimeType: 'video/webm', videoBitsPerSecond: 15000000 });
        } catch {
      ...
      recorder.onstop = () => {
        ...
        setToast(`📥 ${ratio} रेश्यो की एचडी स्मूथ क्लिप डाउनलोड हो गई!`);
      };
